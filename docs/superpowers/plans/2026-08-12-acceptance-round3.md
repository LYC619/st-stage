...
- [x] **Step 1: Write failing lifecycle and inline-label tests**
...
- [x] **Step 3: Implement the minimal lifecycle and insertion behavior**
...
- [x] **Step 1: Write failing tests for raw-message-assisted hiding**
...
- [x] **Step 3: Implement deterministic text mapping**
...
- [x] **Step 3: Implement a string-aware object scanner**
...
- [x] **Step 1: Write failing type/migration/merge tests**
...
- [x] **Step 3: Implement pure preset functions and v6 migration**
...
- [x] **Step 4: Persist only custom packs plus overrides**
...
- [x] **Step 3: Implement pure override transitions**
...
- [x] **Step 4: Rewire gallery actions**
...
- [x] **Step 1: Write failing status and DOM tests**
...
- [x] **Step 3: Implement resource summaries and card UI**
...
- [x] **Step 1: Write failing exact-template tests**
...
- [x] **Step 3: Implement exact known-template recognition**
...
- [x] **Step 1: Write failing slider and shortcut tests**
...
- [x] **Step 3: Implement and wire controls**
...
- [x] **Step 2: Refresh the build stamp and build twice**
...
- [x] **Step 3: Update maintenance evidence**
