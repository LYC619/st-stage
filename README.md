# st-stage — SillyTavern 的「小手机」功能平台

st-stage 是一个 SillyTavern 扩展形态的**功能平台**：装好后聊天界面出现一个可拖动的 **📱 图标**，展开是一部带状态栏、返回键和 Home 键的小手机——st-stage 的所有功能都是手机里的 **App**。
...
> 📍 **设置在哪？** ST 扩展设置页只留总开关（**启用立绘功能**、**显示手机**、**智能精简 Prompt**）。功能设置都在对应 App 里：立绘的显示/轮播/Prompt 在「🎭 立绘」App，图包与图床在「🗂 图库」App。
